...
class NotiMangerActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            NotificationMangerScreen(alarmList = alarmList)
        }
    }
}

@Composable
fun NotificationMangerScreen(alarmList: List<notiDataClass>) {
    Column() {
        Column(
        ...
        NofiManagerSlider(alarmList = alarmList)
    }
}
...
@Composable
fun NofiManagerCard(alarm: notiDataClass) {
    ElevatedCard(
